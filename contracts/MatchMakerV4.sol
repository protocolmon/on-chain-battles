...
contract MatchMakerV4 is Initializable, OwnableUpgradeable {
    ...
    function commit(
        ...
        require(
            ...
            _match.phase == Phase.GameOver
                ? "MatchMakerV4: game over"
                : "MatchMakerV4: not in commit phase"
        );
        ...
        require(relevantMove.commit == 0, "MatchMakerV4: already committed");
    ...
    function reveal(
        ...
        require(
            _match.phase == Phase.Reveal,
            "MatchMakerV4: not in reveal phase"
        );
    ...
    function goToRevealPhase(uint256 matchId) external {
        ...
        require(
            ...
            "MatchMakerV4: timeout not expired"
        );
        _match.phase = Phase.Reveal;
    }
    ...
    function getOtherPlayerInMatch(
        ...
        if (_match.challengerTeam.owner == player) {
            ...
            revert("MatchMakerV4: no other player in match");
        }
    }
    ...
    function join(
        ...
        require(
            ...
            "MatchMakerV4: cannot play against yourself"
        );
